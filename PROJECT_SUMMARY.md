...
- **4 programming languages** (TypeScript, Rust, Julia, SQL/AQL/SPARQL)
...
- `src/index.ts` - Main API server with Hono
- `src/orchestrator/db/arango.ts` - ArangoDB connection & initialization
- `src/orchestrator/db/virtuoso.ts` - Virtuoso connection & ontology
- `src/orchestrator/models/types.ts` - Zod schemas for validation
- `src/orchestrator/services/initiative-service.ts` - Initiative management
- `src/orchestrator/services/analytics-service.ts` - Gap analysis engine
- `src/orchestrator/api/visualizations.ts` - Visualization data prep
...
- `case-studies/synapcor/load-data.ts` - Sample data loader
  - 4 departments
...
- `tests/unit/initiative-service.test.ts` - Initiative service tests
- `tests/unit/analytics-service.test.ts` - Analytics engine tests
...
- **TypeScript/Bun**: Fast async I/O, excellent DX
